...
public class Main {
    public static void main(String[] args) {
        ...
        for (EmployeeUser emp : employees) {
            System.out.println("ID: " + emp.getEmployeeId() + ", Name: " + emp.getName() + ", Email: " + emp.getEmail()
                    + ", Address: " + emp.getAddress() + ", Phone: " + emp.getPhoneNumber());
        }
        ...
        employee.addProduct("P002", "HP notebook7", "HP", "USA", 800, 25000.0F);
        Product[] products = employee.getListOfProducts();
        System.out.println("*****************************************************:");
        System.out.println("List of Products:");
        for (Product prod : products) {
            System.out.println("ID: " + prod.getProductID() + ", Name: " + prod.getProductName() + ", Manufacturer: "
                    + prod.getManufacturerName() + ", Supplier: " + prod.getSupplierName() + ", Quantity: "
                    + prod.getQuantity() + ", Price: " + prod.getPrice());
        }
        ...
        for (CustomerProduct op : operations) {
            System.out.println("Customer SSN: " + op.getCustomerSSN() + ", Product ID: " + op.getProductID()
                    + ", Purchase Date: " + op.getPurchaseDate());
        }
    }
